...
## SENDFILE settings
MEDIA_ROOT = '/data/climdata/TELEDM_CACHE/tmp' # os.path.join(BASE_DIR, 'teledm/tmp'),
SENDFILE_BACKEND = 'sendfile.backends.development'
#SENDFILE_BACKEND = 'sendfile.backends.xsendfile'
#SENDFILE_BACKEND = 'sendfile.backends.nginx'
SENDFILE_ROOT = '/data/climdata/TELEDM_CACHE/tmp' #os.path.join(BASE_DIR, 'teledm/tmp')
SENDFILE_URL = '/data/climdata/TELEDM_CACHE/tmp'  # os.path.join(BASE_DIR, 'teledm/tmp')
...
DATABASES = {
    'default': {
        ...
        'NAME': '/data/climdata/TELEDM_CONF/db.sqlite3', #os.path.join(BASE_DIR, 'db.sqlite3'),
    }
}
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            'level': 'DEBUG',
            'filename': '/data/climdata/TELEDM_CACHE/log/teledm.logs', #os.path.join(BASE_DIR, 'log/teledm.log'),
...
CACHES = {
    'default': {
        ...
        'LOCATION': '/data/climdata/TELEDM_CACHE/tmp', #os.path.join(BASE_DIR, 'teledm/tmp'),
    }
}
